...
Point(200) = {0, 0, -6000, lc_fault};
Point(201) = {0, 0, -5450, lc_fault};
Point(202) = {550, 0, -6000, lc_fault};
Point(203) = {0, 0, -6550, lc_fault};
Point(204) = {-550, 0, -6000, lc_fault};
Point(211) = {0, 0, -5200, lc_fault};
Point(212) = {800, 0, -6000, lc_fault};
Point(213) = {0, 0, -6800, lc_fault};
Point(214) = {-800, 0, -6000, lc_fault};
...
Point(1101) = {12000, 800, -10000, lc};
Point(1102) = {12000, 800, 0, lc};
